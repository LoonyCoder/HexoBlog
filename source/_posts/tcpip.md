---
title: 最全面的TCP/IP协议讲解
categories:
    - 网络通信
    
date: 2019-09-20 09:36:31
tags:
  - 网络通信
  - Http协议
...
大学时期学的最差的专业课就是网络通信，而且目前对于三次握手、四次握手的面试命中率极高，基本上是必考题，所以补补课。
有幸在csdn上拜读到**涤生_Woo**老师的文章，全程跪着看完。
文章转自：[太厉害了，终于有人能把TCP/IP 协议讲的明明白白了](https://blog.csdn.net/wuzhiwei549/article/details/105965493?utm_source=app)


**一图看完本文**
![TCP/IP协议](/images/tcpip/tcp1.jpg)

### 计算机网络体系结构分层

计算机网络体系结构分层

![计算机网络结构](/images/tcpip/tcp2.jpg)

![计算机网络结构分层](/images/tcpip/tcp3.jpg)
...
![数据处理流程](/images/tcpip/tcp7.jpg)

##### 通过 IP 地址、端口号、协议号进行通信识别

- 仅凭目标端口号识别某一个通信是远远不够的。

![数据处理流程](/images/tcpip/tcp8.jpg)

![数据处理流程](/images/tcpip/tcp9.jpg)
...
![序列号和确认应答](/images/tcpip/tcp13.jpg)
...
![序列号和确认应答](/images/tcpip/tcp14.jpg)
...
![部分确认应答丢失](/images/tcpip/tcp16.jpg)
...
![子网掩码](/images/tcpip/tcp22.jpg)

- 第二种表示方式是，在每个 IP 地址后面追加网络地址的位数用 “/” 隔开，如下：

![子网掩码](/images/tcpip/tcp23.jpg)
...
![路由控制表与 IP 包发送](/images/tcpip/tcp24.jpg)
...
![链路本地单播地址](/images/tcpip/tcp27.jpg)
